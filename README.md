...
Еще одним недостатком будет совместное редактирование. Без использования онлайн сайта для совместного редактирования LaTeX, совместная работа над файлом LaTeX в идеале требует отдельного программного обеспечения для контроля правок. В отличие от Word и Google Docs, которые имеют очень хорошие функции комментариев, аннотаций и отслеживания правок.  Еще недостатком можно назвать требование постоянно добавлять пакеты, хотя они очень полезны и нужны, но чрезмерное наличие их в документе сильно разрастают код, которые неудобно редактировать.
